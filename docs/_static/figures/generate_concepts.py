"""Generate the core-concepts figures used by the docs subpages.

Run from the repo root:
    python docs/_static/figures/generate_concepts.py
...
if __name__ == "__main__":
    main()
    print(f"wrote core-concepts figures to {FIGDIR}")
